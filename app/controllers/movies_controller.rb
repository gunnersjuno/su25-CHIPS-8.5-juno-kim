class MoviesController < ApplicationController
  ...
  def add_movie
    @movie = Movie.create(title: params[:title], release_date: params[:release_date], rating: params[:rating])
